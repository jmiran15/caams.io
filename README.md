...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create caams-de51
  fly apps create caams-de51-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app caams-de51
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app caams-de51-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'caams-de51-staging' does not match app name in config file 'caams-de51'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name caams-de51-db
  fly postgres attach --app caams-de51 caams-de51-db

  fly postgres create --name caams-de51-staging-db
  fly postgres attach --app caams-de51-staging caams-de51-staging-db
  ```
